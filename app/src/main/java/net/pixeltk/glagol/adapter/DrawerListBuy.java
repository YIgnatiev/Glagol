...
public class DrawerListBuy extends BaseAdapter {

    private Context context;
    private ArrayList<DrawItemBookMarks> navDrawerItems;
    SuccessfulEnter myTab;

    public DrawerListBuy(Context context, ArrayList<DrawItemBookMarks> navDrawerItems){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.layout_for_buy_item, null);
        }

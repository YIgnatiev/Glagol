...
public class DataBasesHelper extends SQLiteOpenHelper {
    ...
    public void insertBookMarks(String name_author, String book_name, String price, String img_url, String id_book) {
    ...
    public BookMarksHelper getProduct(String productid) {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor2 = db.query(TABLE_BOOKMARKS,
                new String[] {ID, NAME_AUTHOR, BOOK_NAME, PRICE, IMG_URL, ID_BOOK},ID
        ...
        if (cursor2.moveToFirst()) {
            do {
                ...
                bookMarksHelper.setPrice(cursor2.getString(3));
                bookMarksHelper.setImg_url(cursor2.getString(4));
                bookMarksHelper.setId_book(cursor2.getString(5));
